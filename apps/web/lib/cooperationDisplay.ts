...
const descriptions: Record<string, Record<Locale, string>> = {
  COMMISSION_5: {
    ...
    en: "Knitters set their own price while Qin Thread coordinates the order flow, requirements, inspection, and transaction protection."
  },
  PLATFORM_BUYOUT_SERVICE: {
    ...
    en: "Qin Thread commissions selected knitting work for brand or product plans, then manages sales and operations."
  },
  READY_MADE_TO_PLATFORM: {
    "zh-Hant": "織女可提交已完成的成衣作品，由秦時線審核品質、風格與市場需求後進行一次性收購，作品後續納入秦時線自營選品。",
    "zh-Hans": "织女可提交已完成的成衣作品，由秦时线审核品质、风格与市场需求后进行一次性收购，作品后续纳入秦时线自营选品。",
    en: "Finished pieces can be purchased after Qin Thread reviews quality, style, and market fit."
  }
};
